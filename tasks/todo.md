...
- [x] Register the structured task class and the three first-principles gates:
  identifiability, representability, and factor access.
...
- [ ] Compute $\kappa$ and $\varepsilon_{\rm cap}$ for finite LEGO; derive any further
  constants from the exact law before training another model.
